...
public class LQI extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRenderer.setChartTitle("@string/lqi");
        mRenderer.setXTitle("@string/elapse_time");
        mRenderer.setYTitle("@string/lqi");
        ...
        mRenderer.setYAxisMax(255); //Ｙ最大値
        ...
        mRenderer.setPanLimits(new double[]{0, 5000, 0, 300});
        mRenderer.setZoomLimits(new double[]{0, 5000, 0, 300});

        mRenderer.setPointSize(4);

        // 新しいデータ系列の作成
        XYSeries series = new XYSeries("LQI");
