...
public class Voltage extends Activity {
    ...
    private Runnable mLoop = new Runnable() {
        ...
        public void run() {
            ...
            for (; ; ) {
                ...
                String new_str1 = str1.substring(27, 31);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twe_main);
        ...
        mRenderer.setChartTitle("電圧変位");
        mRenderer.setXTitle("経過時間[s]");
        mRenderer.setYTitle("電圧[mV]");
        ...
        mRenderer.setYAxisMin(+2000); //Y最小値
        mRenderer.setYAxisMax(+5000); //Y最大値
        ...
        mRenderer.setPanLimits(new double[]{0, 5000, 0, 5000});
        mRenderer.setZoomLimits(new double[]{0, 5000, 0, 5000});

        mRenderer.setPointSize(4);


        // 新しいデータ系列の作成
        XYSeries series = new XYSeries("電圧");
